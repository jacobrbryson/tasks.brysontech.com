...
use AppBundle\Libraries\Facebook\Authentication\OAuth2Client;
use AppBundle\Libraries\Facebook\FileUpload\FacebookFile;
use AppBundle\Libraries\Facebook\FileUpload\FacebookResumableUploader;
use AppBundle\Libraries\Facebook\FileUpload\FacebookTransferChunk;
use AppBundle\Libraries\Facebook\FileUpload\FacebookVideo;
use AppBundle\Libraries\Facebook\GraphNodes\GraphEdge;
use AppBundle\Libraries\Facebook\Url\UrlDetectionInterface;
use AppBundle\Libraries\Facebook\Url\FacebookUrlDetectionHandler;
use AppBundle\Libraries\Facebook\PseudoRandomString\PseudoRandomStringGeneratorFactory;
use AppBundle\Libraries\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface;
use AppBundle\Libraries\Facebook\HttpClients\HttpClientsFactory;
use AppBundle\Libraries\Facebook\PersistentData\PersistentDataFactory;
use AppBundle\Libraries\Facebook\PersistentData\PersistentDataInterface;
use AppBundle\Libraries\Facebook\Helpers\FacebookCanvasHelper;
use AppBundle\Libraries\Facebook\Helpers\FacebookJavaScriptHelper;
use AppBundle\Libraries\Facebook\Helpers\FacebookPageTabHelper;
use AppBundle\Libraries\Facebook\Helpers\FacebookRedirectLoginHelper;
